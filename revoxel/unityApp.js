const unityApp = {
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "/Revoxel[6]-mirraSDK[5.1.17].loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/Revoxel[6]-mirraSDK[5.1.17].data",
            frameworkUrl: buildUrl + "/Revoxel[6]-mirraSDK[5.1.17].framework.js",
            codeUrl: buildUrl + "/Revoxel[6]-mirraSDK[5.1.17].wasm",
            streamingAssetsUrl: "StreamingAssets",
            companyName: "R-volver Technologies",
            productName: "Revoxel",
            productVersion: "1.9.11",
            showBanner: (msg, type) => {
                switch (type) {
                    case 'error': {
                        console.error(msg);
