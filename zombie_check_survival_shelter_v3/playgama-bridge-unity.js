...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/ZombieCheck[59]-playgama[5.1.7].loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/ZombieCheck[59]-playgama[5.1.7].data',
                        frameworkUrl: 'Build/ZombieCheck[59]-playgama[5.1.7].framework.js',
                        codeUrl: 'Build/ZombieCheck[59]-playgama[5.1.7].wasm',
                        streamingAssetsUrl: 'StreamingAssets',
                        companyName: 'DefaultCompany',
                        productName: 'Zombie Check',
