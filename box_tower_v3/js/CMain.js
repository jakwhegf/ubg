function CMain(oData) {
    ...
    this._initSounds = function(){
        ...
        aSoundsInfo.push({path: './sounds/',filename:'cut',loop:false,volume:1, ingamename: 'cut'});
        ...
        aSoundsInfo.push({path: './sounds/',filename:'perfect',loop:false,volume:1, ingamename: 'perfect'});
    ...
    this._loadImages = function () {
        ...
        s_oSpriteLibrary.addSprite("but_leaderboard","./sprites/leaderBoar.png");
