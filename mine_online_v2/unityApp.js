const unityApp = {
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "/143af691f760893d871f2dd2ff0d3392.loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/cb0a42e620632a71b2d4d376bde353c6.data",
            frameworkUrl: buildUrl + "/965fc3aeb826f0fc570fda58f8bb5fbc.framework.js",
            codeUrl: buildUrl + "/492d897ce94bd5b79101312eda3a2f9a.wasm",
            streamingAssetsUrl: "StreamingAssets",
            companyName: "FinalTale",
            productName: "Mine - Online",
            productVersion: "0.7",
            showBanner: (msg, type) => {
                switch (type) {
                    case 'error': {
